...
internal class UserTemplateTest {
    ...
    @BeforeEach
    fun setup() {
        val credentials = Credentials(username = SlideshowTemplateTest.SLIDESHARE_USERNAME, password = SlideshowTemplateTest.SLIDESHARE_PASSWORD)
        slideShare = SlideShareTemplate(SlideshowTemplateTest.API_KEY, SlideshowTemplateTest.SHARED_SECRET, credentials)
    ...
    fun getUserFavorites() {
        ...
        // Act
        val favorites = userOperations.getFavorites("t28hub")
        ...
        assertEquals(favorites[10].tags.size, 10)
    }
